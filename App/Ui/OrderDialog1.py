...
class Ui_OrderDialog1(object):
    def setupUi(self, OrderDialog1):
        ...
        self.groupBox_4 = QGroupBox(OrderDialog1)
        ...
        self.groupBox_6 = QGroupBox(OrderDialog1)
        ...
        self.groupBox_7 = QGroupBox(OrderDialog1)
        ...
        self.groupBox_8 = QGroupBox(OrderDialog1)
        ...
        self.groupBox_5 = QGroupBox(OrderDialog1)
        ...
        self.pushButtonCashDeskDescription = QPushButton(self.groupBox_10)
        ...
        sizePolicy2.setHeightForWidth(self.pushButtonCashDeskDescription.sizePolicy().hasHeightForWidth())
        self.pushButtonCashDeskDescription.setSizePolicy(sizePolicy2)
        ...
        self.verticalLayout_15.addWidget(self.pushButtonCashDeskDescription)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 1110, 580))
    ...
    def retranslateUi(self, OrderDialog1):
        ...
        self.groupBox_4.setTitle(QCoreApplication.translate("OrderDialog1", u"Deliver to", None))
        ...
        self.groupBox_6.setTitle(QCoreApplication.translate("OrderDialog1", u"Table number", None))
        self.lineEditTable.setInputMask("")
        self.groupBox_7.setTitle(QCoreApplication.translate("OrderDialog1", u"Covers", None))
        self.groupBox_8.setTitle(QCoreApplication.translate("OrderDialog1", u"Customer name", None))
        self.groupBox_5.setTitle(QCoreApplication.translate("OrderDialog1", u"Web order", None))
        ...
        self.groupBox_10.setTitle(QCoreApplication.translate("OrderDialog1", u"Cash desk description", None))
#if QT_CONFIG(tooltip)
        self.pushButtonCashDeskDescription.setToolTip(QCoreApplication.translate("OrderDialog1", u"Click to change the cash desk description", None))
