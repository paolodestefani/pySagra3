...
CREATE TABLE printer_class (
    ...
    --
    printer_class_id        BIGINT GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE printer_class_printer (
    ...
    company_id                  integer NOT NULL,
    --
    printer_class_printer_id    BIGINT GENERATED BY DEFAULT AS IDENTITY,
    printer_class_id            BIGINT NOT NULL,
