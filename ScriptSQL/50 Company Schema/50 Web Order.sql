...
CREATE TABLE web_order_header (
    ...
    --
    web_order_header_id BIGINT GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE web_order_line (
    company_id          integer NOT NULL,
    --
    web_order_line_id   BIGINT GENERATED BY DEFAULT AS IDENTITY,
    web_order_header_id BIGINT NOT NULL,
