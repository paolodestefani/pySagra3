...
CREATE TABLE numbering (
    ...
    CONSTRAINT numbering_sequence_type_check 
        CHECK (sequence_type IN ('ORDERNUM', 'ORDERS')), -- order number and order count 
...
BEGIN
    ...
    IF NOT EXISTS(
        ...
        INSERT INTO company.numbering (sequence_type, company_id, event_id, event_date, day_part, current_value) 
