...
CREATE TABLE itemview_adapt (
    ...
    --
    itemview_adapt_id       integer GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE sortfilter_adapt (
    ...
    object_version          integer NOT NULL,
    --
    sortfilter_adapt_id     integer GENERATED BY DEFAULT AS IDENTITY,
	description             text NOT NULL,
...
CREATE TABLE system.sortfilter_user_default (
    ...
    object_version          integer NOT NULL,
    --
	user_default_id         integer GENERATED BY DEFAULT AS IDENTITY,
    sortfilter_adapt_id     integer,
